# VBA Module 2 Challenge: Stock Market Analysis

## Overview

This project involves analyzing market data for the years 2017, 2018, and 2019 using VBA scripting. The script iterates through each worksheet to calculate various metrics for each stock, including the ticker symbol, yearly change, percentage change, and total stock volume. Additionally, the script identifies stocks with the "Greatest % increase", "Greatest % decrease", and "Greatest total volume". 
